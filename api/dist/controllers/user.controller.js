        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (user) {
                    ...
                    return [2 /*return*/, res.status(404).json({ msg: "User Not Found", status: 404 })];
                }
                return [3 /*break*/, 3];
            case 2:
                err_2 = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                result = _a.sent();
                if (result.affected) {
                    return [2 /*return*/, res.json({ msg: "User Deleted", status: 200, id: +req.params.id })];
                }
                return [2 /*return*/, res.json({ msg: "User Not Found", status: 404 })];
            case 2:
                err_5 = _a.sent();
